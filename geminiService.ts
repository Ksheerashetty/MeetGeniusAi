...
- Body: Professional HTML content using these exact sections:
    - Greeting: "Hi [Name],"
    - Summary Section: "<h3>📝 Executive Summary</h3>" followed by the summary.
    - Personal Tasks: "<h3>✅ Your Action Items</h3>". List ONLY tasks assigned to THIS person. If none, state "No specific action items assigned."
    - Global Decisions: "<h3>📌 Key Decisions</h3>" listing all meeting decisions.
